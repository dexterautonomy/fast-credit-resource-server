...
public class SwaggerConfig implements WebMvcConfigurer {
	...
	private ApiInfo metaData() {
		return new ApiInfo("Resource Server API for Fast Credit Limited User Management API", "Documentation", "1.0", "Terms of service",
				new Contact("Fast Credit Group", "www.fastcredit-ng.com", "info@fastcredit-ng.com"), "License of API",
